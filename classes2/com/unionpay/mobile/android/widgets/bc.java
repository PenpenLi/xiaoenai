  ...
  implements t.a
{
  ...
  public bc(Context paramContext, int paramInt, JSONObject paramJSONObject)
  {
    super(paramContext, paramInt, paramJSONObject);
    this.r = g.a(paramJSONObject, "point");
    this.q = g.a(paramJSONObject, "max_use_point");
    this.p = g.a(paramJSONObject, "min_use_point");
    this.s = g.a(paramJSONObject, "ratio");
    this.o = g.a(paramJSONObject, "ordr_amnt");
    this.b.a(8194);
    ...
    {
      s();
      c(String.format(c.by.ay, new Object[] { this.r, this.s }));
    }
    this.b.a(this);
  }
  ...
  private void a(String paramString1, String paramString2)
  {
    if ((o() == null) || (o().length() == 0))
    {
      ...
      paramString2 = String.format(c.by.aw, new Object[] { this.q });
    ...
    for (;;)
    {
      ...
      return;
      label87:
      String str = String.format(c.by.aw + paramString1, new Object[] { this.q, paramString2 });
  ...
  public final void a(Editable paramEditable)
  {
    ...
    try
    {
      ...
      a(c.by.ax, paramEditable.toString());
      return;
    }
    ...
    implements InputFilter
  {
    ...
    public a(t paramt, BigDecimal paramBigDecimal1, BigDecimal paramBigDecimal2)
    {
      this.b = paramt;
...
/* Location:              E:\apk\xiaoenai2\classes2-dex2jar.jar!\com\unionpay\mobile\android\widgets\bc.class
