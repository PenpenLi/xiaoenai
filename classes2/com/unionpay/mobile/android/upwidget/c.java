  ...
  extends BaseAdapter
{
  ...
  public final View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((e()) && (n != 0))
    {
      ...
      paramInt = com.unionpay.mobile.android.utils.d.a(this.d, 20.0F);
    ...
    int i3 = com.unionpay.mobile.android.utils.d.a(this.d, 20.0F);
    if (this.j == 0) {
      if (this.h)
      {
        paramView = this.b;
    ...
    for (;;)
    {
      if ((!e()) || (n == 0))
      {
        ...
        if (this.j == 1)
        {
          ...
          i1 = 1008;
          i4 = com.unionpay.mobile.android.utils.d.a(this.d, 20.0F);
...
/* Location:              E:\apk\xiaoenai2\classes2-dex2jar.jar!\com\unionpay\mobile\android\upwidget\c.class
