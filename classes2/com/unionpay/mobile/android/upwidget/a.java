  ...
  extends LinearLayout
{
  ...
  private a(Context paramContext, JSONObject paramJSONObject, View.OnClickListener paramOnClickListener, byte paramByte)
  {
    ...
    this.b = g.a(paramJSONObject, "value");
    this.c = g.a(paramJSONObject, "label");
    this.d = g.a(paramJSONObject, "href_label");
    this.e = g.a(paramJSONObject, "href_url");
    this.f = g.a(paramJSONObject, "href_title");
    this.g = g.a(paramJSONObject, "checked");
    this.h = g.a(paramJSONObject, "required");
    this.i = g.a(paramJSONObject, "error_info");
    this.o = g.a(paramJSONObject, "ckb_style");
  ...
  private void g()
  {
    ...
    label66:
    for (int i2 = d.a(this.l, 15.0F);; i2 = com.unionpay.mobile.android.global.a.w)
    {
...
/* Location:              E:\apk\xiaoenai2\classes2-dex2jar.jar!\com\unionpay\mobile\android\upwidget\a.class
