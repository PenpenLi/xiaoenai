...
public class a
{
  ...
  public static byte[] a(File paramFile, String paramString)
  {
    ...
    //   49: aload_3
    //   50: astore_2
    //   51: new 1111	java/io/ByteArrayInputStream
    //   54: dup
    //   55: aload_1
    //   56: ldc_w 1113
    //   59: invokevirtual 1079	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   62: invokespecial 1114	java/io/ByteArrayInputStream:<init>	([B)V
    //   65: astore 5
    //   67: new 1116	java/io/ByteArrayOutputStream
    //   70: dup
    //   71: invokespecial 1117	java/io/ByteArrayOutputStream:<init>	()V
    //   74: astore 6
    //   76: new 979	java/util/zip/ZipOutputStream
    //   79: dup
    //   80: aload 6
    //   82: invokespecial 985	java/util/zip/ZipOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   85: astore_1
    //   86: aload_1
    //   87: astore_3
    //   88: aload_0
    ...
    //   91: aload_1
    //   92: bipush 8
    //   94: invokevirtual 988	java/util/zip/ZipOutputStream:setMethod	(I)V
    //   97: aload_1
    //   98: astore_3
    //   99: aload_0
    //   100: astore 4
    //   102: aload_1
    //   103: new 990	java/util/zip/ZipEntry
    //   106: dup
    //   107: aload_2
    //   108: invokespecial 992	java/util/zip/ZipEntry:<init>	(Ljava/lang/String;)V
    //   111: invokevirtual 996	java/util/zip/ZipOutputStream:putNextEntry	(Ljava/util/zip/ZipEntry;)V
    //   114: aload_1
    //   115: astore_3
    //   116: aload_0
    //   117: astore 4
    ...
    //   134: aload_0
    //   135: aload_2
    //   136: invokevirtual 1000	java/io/FileInputStream:read	([B)I
    //   139: istore 7
    //   141: iload 7
    //   143: ifle +70 -> 213
    //   146: aload_1
    ...
    //   153: iconst_0
    //   154: iload 7
    //   156: invokevirtual 1003	java/util/zip/ZipOutputStream:write	([BII)V
    //   159: goto -30 -> 129
    //   162: astore_2
    //   163: aload_1
    //   164: astore_3
    ...
    //   185: ifnull +7 -> 192
    //   188: aload_0
    //   189: invokevirtual 1004	java/io/FileInputStream:close	()V
    //   192: aload_1
    //   193: ifnull +7 -> 200
    //   196: aload_1
    //   197: invokevirtual 1005	java/util/zip/ZipOutputStream:close	()V
    //   200: ldc_w 1007
    //   203: iconst_0
    ...
    //   218: aload 5
    //   220: aload_2
    //   221: invokevirtual 1118	java/io/ByteArrayInputStream:read	([B)I
    //   224: istore 7
    //   226: iload 7
    //   228: ifle +54 -> 282
    //   231: aload_1
    ...
    //   238: iconst_0
    //   239: iload 7
    //   241: invokevirtual 1003	java/util/zip/ZipOutputStream:write	([BII)V
    //   244: goto -31 -> 213
    //   247: astore_1
    //   248: aload 4
    //   250: astore_0
    ...
    //   254: ifnull +7 -> 261
    //   257: aload_0
    //   258: invokevirtual 1004	java/io/FileInputStream:close	()V
    //   261: aload_2
    //   262: ifnull +7 -> 269
    //   265: aload_2
    //   266: invokevirtual 1005	java/util/zip/ZipOutputStream:close	()V
    //   269: ldc_w 1007
    //   272: iconst_0
    ...
    //   285: astore 4
    //   287: aload_1
    //   288: invokevirtual 1013	java/util/zip/ZipOutputStream:closeEntry	()V
    //   291: aload_1
    //   292: astore_3
    //   293: aload_0
    //   294: astore 4
    //   296: aload_1
    //   297: invokevirtual 1010	java/util/zip/ZipOutputStream:flush	()V
    //   300: aload_1
    //   301: astore_3
    //   302: aload_0
    //   303: astore 4
    //   305: aload_1
    //   306: invokevirtual 1121	java/util/zip/ZipOutputStream:finish	()V
    //   309: aload_1
    //   310: astore_3
    //   311: aload_0
    //   312: astore 4
    //   314: aload 6
    //   316: invokevirtual 1124	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   319: astore_2
    //   320: aload_0
    //   321: ifnull +7 -> 328
    //   324: aload_0
    //   325: invokevirtual 1004	java/io/FileInputStream:close	()V
    //   328: aload_1
    //   329: invokevirtual 1005	java/util/zip/ZipOutputStream:close	()V
    //   332: ldc_w 1007
    //   335: iconst_0
  ...
  public static long h()
  {
    ...
    //   0: aconst_null
    //   1: astore_3
    //   2: new 1385	java/io/FileReader
    //   5: dup
    //   6: ldc_w 1387
    //   9: invokespecial 1388	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   12: astore_2
    //   13: new 589	java/io/BufferedReader
    //   16: dup
    //   17: aload_2
    //   18: sipush 2048
    //   21: invokespecial 1391	java/io/BufferedReader:<init>	(Ljava/io/Reader;I)V
    //   24: astore_1
    //   25: aload_1
    //   26: invokevirtual 606	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   29: ldc_w 1393
    //   32: iconst_2
    //   33: invokevirtual 1397	java/lang/String:split	(Ljava/lang/String;I)[Ljava/lang/String;
    //   36: iconst_1
    //   37: aaload
    //   38: invokevirtual 554	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   41: ldc_w 1399
    //   44: ldc 95
    //   46: invokevirtual 1403	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   49: invokevirtual 644	java/lang/String:trim	()Ljava/lang/String;
    //   52: invokestatic 1246	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   55: lstore 4
    //   57: lload 4
    //   59: bipush 10
    //   61: lshl
    ...
    //   68: aload_2
    //   69: invokevirtual 1404	java/io/FileReader:close	()V
    //   72: lload 4
    //   74: lreturn
    //   75: astore_0
    //   76: aload_0
    ...
    //   130: ifnull +7 -> 137
    //   133: aload_0
    //   134: invokevirtual 1404	java/io/FileReader:close	()V
    //   137: ldc2_w 1405
    //   140: lreturn
    //   141: astore_1
    //   142: aload_1
    ...
    //   185: ifnull +7 -> 192
    //   188: aload_2
    //   189: invokevirtual 1404	java/io/FileReader:close	()V
    //   192: aload_0
    //   193: athrow
    //   194: astore_1
    //   195: aload_1
  ...
  public static long i()
  {
    ...
    //   34: ldc_w 1393
    //   37: iconst_2
    //   38: invokevirtual 1397	java/lang/String:split	(Ljava/lang/String;I)[Ljava/lang/String;
    //   41: iconst_1
    //   42: aaload
    //   43: invokevirtual 554	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   46: ldc_w 1399
    //   49: ldc 95
    //   51: invokevirtual 1403	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   54: invokevirtual 644	java/lang/String:trim	()Ljava/lang/String;
    //   57: invokestatic 1246	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   60: lstore 4
    //   62: aload_1
    //   63: invokevirtual 606	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   66: ldc_w 1393
    //   69: iconst_2
    //   70: invokevirtual 1397	java/lang/String:split	(Ljava/lang/String;I)[Ljava/lang/String;
    //   73: iconst_1
    //   74: aaload
    //   75: invokevirtual 554	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   78: ldc_w 1399
    //   81: ldc 95
    //   83: invokevirtual 1403	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   86: invokevirtual 644	java/lang/String:trim	()Ljava/lang/String;
    //   89: invokestatic 1246	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   92: lstore 6
    //   94: aload_1
    //   95: invokevirtual 606	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   98: ldc_w 1393
    //   101: iconst_2
    //   102: invokevirtual 1397	java/lang/String:split	(Ljava/lang/String;I)[Ljava/lang/String;
    //   105: iconst_1
    //   106: aaload
    //   107: invokevirtual 554	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   110: ldc_w 1399
    //   113: ldc 95
    //   115: invokevirtual 1403	java/lang/String:replace	(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    //   118: invokevirtual 644	java/lang/String:trim	()Ljava/lang/String;
    //   121: invokestatic 1246	java/lang/Long:parseLong	(Ljava/lang/String;)J
    //   124: lstore 8
    //   126: lload 4
    //   128: bipush 10
    //   130: lshl
    ...
    //   149: aload_2
    //   150: invokevirtual 1404	java/io/FileReader:close	()V
    //   153: lload 4
    //   155: lreturn
    //   156: astore_0
    //   157: aload_0
    ...
    //   211: ifnull +7 -> 218
    //   214: aload_0
    //   215: invokevirtual 1404	java/io/FileReader:close	()V
    //   218: ldc2_w 1405
    //   221: lreturn
    //   222: astore_1
    //   223: aload_1
    ...
    //   266: ifnull +7 -> 273
    //   269: aload_2
    //   270: invokevirtual 1404	java/io/FileReader:close	()V
    //   273: aload_0
    //   274: athrow
    //   275: astore_1
    //   276: aload_1
...
/* Location:              E:\apk\xiaoenai2\classes2-dex2jar.jar!\com\tencent\bugly\proguard\a.class
