  ...
  implements Parcelable
{
  ...
  public void parse(JSONObject paramJSONObject)
  {
    ...
    a.c("===================mId = {}", new Object[] { Integer.valueOf(this.mId) });
    a.c("===================mDetailTitle = {}", new Object[] { this.mDetailTitle });
    this.mDesc = paramJSONObject.optString("desc", "");
    a.c("===================mDesc = {}", new Object[] { this.mDesc });
    this.mFlags = paramJSONObject.optString("flags", "");
    if (this.mFlags.length() > 0)
    {
      this.mFlagArray = Pattern.compile(",").split(this.mFlags);
      a.c("===================mFlags = {}", new Object[] { this.mFlags });
      a.c("===================mFlagArray = {}", new Object[] { Integer.valueOf(this.mFlagArray.length) });
    }
    this.mCtlOnlyCount = paramJSONObject.optInt("ctl_only_count", 0);
    a.c("===================mCtlOnlyCount = {}", new Object[] { Integer.valueOf(this.mCtlOnlyCount) });
    this.mSellingCount = paramJSONObject.optInt("selling_count", 0);
    a.c("===================mSellingCount = {}", new Object[] { Integer.valueOf(this.mSellingCount) });
    this.mStoreCount = paramJSONObject.optInt("store_count", 0);
    a.c("===================mStoreCount = {}", new Object[] { Integer.valueOf(this.mStoreCount) });
    this.mPrice = paramJSONObject.optLong("price", 0L);
    a.c("===================mPrice = {}", new Object[] { Long.valueOf(this.mPrice) });
    this.mSellingTime = paramJSONObject.optInt("selling_time");
    a.c("===================mSellingTime = {}", new Object[] { Long.valueOf(this.mSellingTime) });
    a.c("===================mSellingTime = {}", new Object[] { ak.j(this.mSellingTime) });
    this.mCloseTime = paramJSONObject.optInt("close_time", 0);
    a.c("===================mCloseTime = {}", new Object[] { Long.valueOf(this.mCloseTime) });
    a.c("===================mCloseTime = {}", new Object[] { ak.j(this.mCloseTime) });
    this.mProductStatus = paramJSONObject.optInt("product_status", 0);
    a.c("===================mProductStatus = {}", new Object[] { Integer.valueOf(this.mProductStatus) });
    this.mProductSubStatus = paramJSONObject.optInt("product_sub_status", 0);
    a.c("===================mProductSubStatus = {}", new Object[] { Integer.valueOf(this.mProductSubStatus) });
    this.mOrderChanceDesc = paramJSONObject.optString("order_chance_desc");
    a.c("===================mOrderChanceDesc = {}", new Object[] { this.mOrderChanceDesc });
    this.mFavored = paramJSONObject.optBoolean("favored", false);
    a.c("===================mFavored = {}", new Object[] { Boolean.valueOf(this.mFavored) });
    this.mDetailPage = paramJSONObject.optString("detail_page");
    a.c("===================mDetailPage = {}", new Object[] { this.mDetailPage });
    this.mShareUrl = paramJSONObject.optString("share_url", "");
    a.c("===================mShareUrl = {}", new Object[] { this.mShareUrl });
    this.mCommentCount = paramJSONObject.optInt("comment_count", 0);
    a.c("===================comment_count = {}", new Object[] { Integer.valueOf(this.mCommentCount) });
    ...
    a.c("===================mArguments = {}", new Object[] { this.mArguments.toString() });
  }
...
/* Location:              E:\apk\xiaoenai2\classes2-dex2jar.jar!\com\xiaoenai\app\model\street\ProductDetail.class
