...
public class c
{
  private static final Interpolator v = new d();
  private int a;
  private int b;
  private int c = -1;
  private float[] d;
      ...
      if ((this.p & i2) != 0)
      {
        ...
        else if (this.a == 2)
        {
          ...
          if (paramMotionEvent == this.s)
          {
            ...
            e(MotionEventCompat.getPointerId(paramMotionEvent, i1));
            continue;
            b();
          }
        }
  ...
  {
    return (c(paramInt2)) && ((this.h[paramInt2] & paramInt1) != 0);
  }
...
/* Location:              E:\apk\xiaoenai2\classes2-dex2jar.jar!\com\xiaoenai\app\widget\swipe\c.class
