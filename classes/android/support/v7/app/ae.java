...
class ae
{
  ...
  private void a(@NonNull Location paramLocation)
  {
    ...
    ad localad = ad.a();
    localad.a(l1 - 86400000L, paramLocation.getLatitude(), paramLocation.getLongitude());
    long l2 = localad.a;
    localad.a(l1, paramLocation.getLatitude(), paramLocation.getLongitude());
    if (localad.c == 1) {}
    long l3;
    long l4;
    long l5;
    for (boolean bool = true;; bool = false)
    {
      l3 = localad.b;
      l4 = localad.a;
      localad.a(86400000L + l1, paramLocation.getLatitude(), paramLocation.getLongitude());
      l5 = localad.b;
      if ((l3 != -1L) && (l4 != -1L)) {
        break;
      }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\android\support\v7\app\ae.class
