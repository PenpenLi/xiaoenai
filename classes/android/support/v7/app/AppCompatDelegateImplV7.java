...
class AppCompatDelegateImplV7
  extends m
  implements LayoutInflaterFactory, f.a
{
  private boolean A;
  ...
  private PanelFeatureState a(int paramInt, boolean paramBoolean)
  {
    ...
    else
    {
      ...
      this.B = ((PanelFeatureState[])localObject1);
    }
  ...
  {
    if ((paramBoolean) && (paramPanelFeatureState.a == 0) && (this.r != null) && (this.r.isOverflowMenuShowing())) {
  ...
  private void a(f paramf, boolean paramBoolean)
  {
    ...
    {
      paramf = p();
      if ((!this.r.isOverflowMenuShowing()) || (!paramBoolean)) {
        if ((paramf != null) && (!o()))
        {
          ...
          if ((localPanelFeatureState.j != null) && (!localPanelFeatureState.r) && (paramf.onPreparePanel(0, localPanelFeatureState.i, localPanelFeatureState.j)))
          {
            paramf.onMenuOpened(108, localPanelFeatureState.j);
  ...
  private boolean b(PanelFeatureState paramPanelFeatureState)
  {
    ...
    for (;;)
    {
      ...
      paramPanelFeatureState.a((f)localObject1);
      return true;
  ...
  private boolean b(PanelFeatureState paramPanelFeatureState, KeyEvent paramKeyEvent)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if ((paramPanelFeatureState.i != null) || ((i != 0) && ((l() instanceof ab)))) {
        break label412;
      }
  ...
  private boolean e(int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    PanelFeatureState localPanelFeatureState = a(paramInt, true);
    if ((paramInt == 0) && (this.r != null) && (this.r.canShowOverflowMenu()) && (!ViewConfigurationCompat.hasPermanentMenuKey(ViewConfiguration.get(this.a)))) {
      if (!this.r.isOverflowMenuShowing())
      {
        if ((o()) || (!b(localPanelFeatureState, paramKeyEvent))) {
          break label226;
        }
        bool1 = this.r.showOverflowMenu();
      }
    }
    for (;;)
    {
  ...
  private int g(int paramInt)
  {
    ...
    if ((this.n != null) && ((this.n.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)))
    {
      ...
      if (this.n.isShown())
      {
        ...
        ViewUtils.computeFitSystemWindows(this.v, (Rect)localObject2, localRect);
        if (localRect.top == 0)
        {
          i = paramInt;
  ...
  private void s()
  {
    if (!this.u)
    {
      ...
      if ((!o()) && ((localObject == null) || (((PanelFeatureState)localObject).j == null))) {
        e(108);
      }
    }
  }
    ...
    for (;;)
    {
      if (localObject == null)
      {
        ...
        for (localObject = new d(this.a, ((TypedValue)localObject).resourceId);; localObject = this.a)
        {
          ...
          this.r = ((DecorContentParent)((ViewGroup)localObject).findViewById(a.f.decor_content_parent));
        ...
        for (localObject = (ViewGroup)((LayoutInflater)localObject).inflate(a.h.abc_screen_simple_overlay_action_mode, null);; localObject = (ViewGroup)((LayoutInflater)localObject).inflate(a.h.abc_screen_simple, null))
        {
          ...
          ViewCompat.setOnApplyWindowInsetsListener((View)localObject, new r(this));
          break;
        }
        label487:
        ((FitWindowsViewGroup)localObject).setOnFitSystemWindowsListener(new s(this));
        continue;
      }
      if (this.r == null) {
    ...
    for (;;)
    {
      ...
      catch (AbstractMethodError localAbstractMethodError)
      {
        ...
        else
        {
          ...
          ((b)localObject1).d();
          this.n.initForMode((b)localObject1);
        ...
        this.n = ((ActionBarContextView)((ViewStubCompat)localObject1).inflate());
        continue;
        boolean bool = false;
        continue;
        this.m = null;
  ...
  public b b(b.a parama)
  {
    ...
    if (localActionBar != null)
    {
      this.m = localActionBar.a(parama);
      if ((this.m != null) && (this.e != null)) {
        this.e.a(this.m);
      }
    }
  ...
  public View b(View paramView, String paramString, @NonNull Context paramContext, @NonNull AttributeSet paramAttributeSet)
  {
    ...
    {
      return this.K.a(paramView, paramString, paramContext, paramAttributeSet, bool2, bool1, true, VectorEnabledTintResources.shouldBeUsed());
      bool1 = false;
      break;
    }
  }
  ...
  public void k()
  {
    ...
    for (;;)
    {
      ...
      if ((this.c instanceof Activity)) {
        this.f = new af((Activity)this.c, this.i);
      }
      while (this.f != null)
      {
        this.f.c(this.H);
    ...
    implements m.a
  {
    ...
    {
      Window.Callback localCallback = AppCompatDelegateImplV7.this.p();
      if (localCallback != null) {
    ...
    implements b.a
  {
    ...
    public void a(b paramb)
    {
      ...
      if (AppCompatDelegateImplV7.this.n != null)
      {
        ...
        AppCompatDelegateImplV7.this.q.setListener(new x(this));
      }
    ...
    implements m.a
  {
    ...
    public void onCloseMenu(f paramf, boolean paramBoolean)
    {
      ...
      for (int i = 1;; i = 0)
      {
        ...
        if (paramf != null)
        {
          ...
          AppCompatDelegateImplV7.a(AppCompatDelegateImplV7.this, paramf.a, paramf, localf);
    ...
    public boolean onOpenSubMenu(f paramf)
    {
      if ((paramf == null) && (AppCompatDelegateImplV7.this.h))
      {
        Window.Callback localCallback = AppCompatDelegateImplV7.this.p();
        if ((localCallback != null) && (!AppCompatDelegateImplV7.this.o())) {
          localCallback.onMenuOpened(108, paramf);
        }
      }
      return true;
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\android\support\v7\app\AppCompatDelegateImplV7.class
