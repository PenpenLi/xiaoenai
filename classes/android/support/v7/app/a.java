...
class a
{
  ...
  public a(Context paramContext, z paramz, Window paramWindow)
  {
    this.a = paramContext;
    this.b = paramz;
    this.c = paramWindow;
  ...
  private void a(ViewGroup paramViewGroup, View paramView, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (this.e != null)
        {
          this.w.setOnScrollChangeListener(new c(this, paramView, (View)localObject));
          this.w.post(new d(this, paramView, (View)localObject));
          return;
        }
        if (this.f != null)
        {
          this.f.setOnScrollListener(new e(this, paramView, (View)localObject));
          this.f.post(new f(this, paramView, (View)localObject));
          return;
        }
        if (paramView != null) {
  ...
  public static class a
  {
    ...
    {
      ListView localListView = (ListView)this.b.inflate(a.k(parama), null);
      Object localObject;
      if (this.D) {
        if (this.H == null)
        {
          localObject = new g(this, this.a, a.l(parama), 16908308, this.s, localListView);
          if (this.L != null) {
            this.L.a(localListView);
          }
          a.a(parama, (ListAdapter)localObject);
          a.a(parama, this.F);
          if (this.u == null) {
            break label270;
          }
          localListView.setOnItemClickListener(new i(this, parama));
          label106:
          if (this.K != null) {
      ...
      for (;;)
      {
        a.a(parama, localListView);
        return;
        localObject = new h(this, this.a, this.H, false, localListView, parama);
        break;
        if (this.E) {}
        for (int i1 = a.m(parama);; i1 = a.n(parama))
        {
          if (this.H == null) {
            break label232;
          }
        ...
        localObject = new a.c(this.a, i1, 16908308, this.s);
        break;
        label270:
        if (this.G == null) {
          break label106;
        }
        localListView.setOnItemClickListener(new j(this, localListView, parama));
        break label106;
        label294:
        if (this.D) {
    ...
    public void a(a parama)
    {
      if (this.g != null)
      {
        ...
        if (this.i != null) {
          parama.a(-1, this.i, this.j, null);
        }
        if (this.k != null) {
          parama.a(-2, this.k, this.l, null);
        }
        if (this.m != null) {
          parama.a(-3, this.m, this.n, null);
        }
        ...
        parama.a(this.w, this.x, this.y, this.z, this.A);
      }
      label227:
      label236:
      while (this.v == 0)
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\android\support\v7\app\a.class
