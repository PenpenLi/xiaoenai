  ...
  implements SupportMenu
{
  ...
  private static int a(ArrayList<h> paramArrayList, int paramInt)
  {
    ...
    while (i1 >= 0)
    {
      if (((h)paramArrayList.get(i1)).b() <= paramInt) {
        return i1 + 1;
      }
      i1 -= 1;
    }
  ...
  private boolean a(q paramq, m paramm)
  {
    boolean bool = false;
    if (this.w.isEmpty()) {
      return false;
    ...
    if (paramm != null) {
      bool = paramm.a(paramq);
    }
    paramm = this.w.iterator();
    m localm;
    if (paramm.hasNext())
    {
  ...
  public void a(Bundle paramBundle)
  {
    ...
    for (Object localObject1 = null; i1 < i2; localObject1 = localObject3)
    {
      ...
      if (localMenuItem.hasSubMenu()) {
        ((q)localMenuItem.getSubMenu()).a(paramBundle);
      }
      i1 += 1;
    }
    if (localObject1 != null) {
  ...
  {
    this.w.add(new WeakReference(paramm));
  ...
  void a(MenuItem paramMenuItem)
  {
    ...
    if (i1 < i3)
    {
      ...
      if ((localh.getGroupId() != i2) || (!localh.f())) {}
  ...
  {
    return (this.i != null) && (this.i.onMenuItemSelected(paramf, paramMenuItem));
  }
  ...
  public boolean a(MenuItem paramMenuItem, m paramm, int paramInt)
  {
    ...
    {
      return bool1;
      bool1 = ((h)localObject).a();
      paramMenuItem = ((h)localObject).getSupportActionProvider();
      ...
      if (!((h)localObject).hasSubMenu()) {
        ((h)localObject).a(new q(e(), this, (h)localObject));
      }
      localObject = (q)((h)localObject).getSubMenu();
      if (i1 != 0) {
        paramMenuItem.onPrepareSubMenu((SubMenu)localObject);
      }
      bool2 = a((q)localObject, paramm) | bool1;
      bool1 = bool2;
    } while (bool2);
    a(true);
    return bool2;
  ...
  public SubMenu addSubMenu(int paramInt1, int paramInt2, int paramInt3, CharSequence paramCharSequence)
  {
    ...
    q localq = new q(this.e, this, paramCharSequence);
    paramCharSequence.a(localq);
    return localq;
  }
    ...
    do
    {
      ...
      do
      {
        ...
        while (i1 < i2)
        {
          ...
          if (localMenuItem.hasSubMenu()) {
            ((q)localMenuItem.getSubMenu()).b(paramBundle);
          }
          i1 += 1;
        }
  ...
  {
    public abstract boolean onMenuItemSelected(f paramf, MenuItem paramMenuItem);
    
    public abstract void onMenuModeChange(f paramf);
  }
  
  public static abstract interface b
  {
    public abstract boolean invokeItem(h paramh);
  }
}


/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\android\support\v7\view\menu\f.class
