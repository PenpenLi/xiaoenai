      ...
      for (;;)
      {
        ...
        if (i == 0)
        {
          ...
          else
          {
            ...
            {
              if (!localb.d()) {
                if ((b.a(localb) != null) && (b.a(localb).hasSubMenu())) {
                  localb.c();
                } else {
                  localb.b();
                }
  ...
  private class b
  {
    ...
    private void a(MenuItem paramMenuItem)
    {
      ...
      else
      {
        ...
        MenuItemCompat.setActionView(paramMenuItem, (View)a(this.w, g.b(), g.d(g.this)));
      }
      for (;;)
      {
        if (this.v > 0)
    ...
    public void b(AttributeSet paramAttributeSet)
    {
      ...
      for (this.z = ((ActionProvider)a(this.x, g.a(), g.b(g.this)));; this.z = null)
      {
        paramAttributeSet.recycle();
        this.i = false;
        return;
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\android\support\v7\view\g.class
