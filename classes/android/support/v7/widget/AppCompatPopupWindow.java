  ...
  extends PopupWindow
{
  ...
  public AppCompatPopupWindow(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = TintTypedArray.obtainStyledAttributes(paramContext, paramAttributeSet, a.k.PopupWindow, paramInt, 0);
    if (paramContext.hasValue(a.k.PopupWindow_overlapAnchor)) {
      setSupportOverlapAnchor(paramContext.getBoolean(a.k.PopupWindow_overlapAnchor, false));
    }
  ...
  private static void wrapOnScrollChangedListener(PopupWindow paramPopupWindow)
  {
    try
    {
      ...
      localField2.set(paramPopupWindow, new q(localField1, paramPopupWindow, (ViewTreeObserver.OnScrollChangedListener)localField2.get(paramPopupWindow)));
      return;
    }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\android\support\v7\widget\AppCompatPopupWindow.class
