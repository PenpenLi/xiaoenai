  ...
  extends ViewGroup
{
  ...
  public LinearLayoutCompat(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = TintTypedArray.obtainStyledAttributes(paramContext, paramAttributeSet, a.k.LinearLayoutCompat, paramInt, 0);
    ...
    this.mWeightSum = paramContext.getFloat(a.k.LinearLayoutCompat_android_weightSum, -1.0F);
    this.mBaselineAlignedChildIndex = paramContext.getInt(a.k.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
    this.mUseLargestChild = paramContext.getBoolean(a.k.LinearLayoutCompat_measureWithLargestChild, false);
    setDividerDrawable(paramContext.getDrawable(a.k.LinearLayoutCompat_divider));
    this.mShowDividers = paramContext.getInt(a.k.LinearLayoutCompat_showDividers, 0);
    this.mDividerPadding = paramContext.getDimensionPixelSize(a.k.LinearLayoutCompat_dividerPadding, 0);
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\android\support\v7\widget\LinearLayoutCompat.class
