  ...
  implements c
{
  ...
  static final a HIDDEN_METHOD_INVOKER;
  ...
  private final View.OnClickListener mOnClickListener = new bn(this);
  private OnCloseListener mOnCloseListener;
  private final TextView.OnEditorActionListener mOnEditorActionListener = new bp(this);
  private final AdapterView.OnItemClickListener mOnItemClickListener = new bf(this);
  private final AdapterView.OnItemSelectedListener mOnItemSelectedListener = new bg(this);
  ...
  private Runnable mReleaseCursorRunnable = new bj(this);
  ...
  private Runnable mShowImeRunnable = new be(this);
  private final View mSubmitArea;
  private boolean mSubmitButtonEnabled;
  private final int mSuggestionCommitIconResId;
  private final int mSuggestionRowLayout;
  private CursorAdapter mSuggestionsAdapter;
  View.OnKeyListener mTextKeyListener = new bo(this);
  private TextWatcher mTextWatcher = new bh(this);
  private final Runnable mUpdateDrawableStateRunnable = new bi(this);
  ...
  public SearchView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramAttributeSet = TintTypedArray.obtainStyledAttributes(paramContext, paramAttributeSet, a.k.SearchView, paramInt, 0);
    ...
    this.mSearchPlate.setBackgroundDrawable(paramAttributeSet.getDrawable(a.k.SearchView_queryBackground));
    this.mSubmitArea.setBackgroundDrawable(paramAttributeSet.getDrawable(a.k.SearchView_submitBackground));
    this.mSearchButton.setImageDrawable(paramAttributeSet.getDrawable(a.k.SearchView_searchIcon));
    this.mGoButton.setImageDrawable(paramAttributeSet.getDrawable(a.k.SearchView_goIcon));
    this.mCloseButton.setImageDrawable(paramAttributeSet.getDrawable(a.k.SearchView_closeIcon));
    this.mVoiceButton.setImageDrawable(paramAttributeSet.getDrawable(a.k.SearchView_voiceIcon));
    this.mCollapsedIcon.setImageDrawable(paramAttributeSet.getDrawable(a.k.SearchView_searchIcon));
    this.mSearchHintIcon = paramAttributeSet.getDrawable(a.k.SearchView_searchHintIcon);
    this.mSuggestionRowLayout = paramAttributeSet.getResourceId(a.k.SearchView_suggestionRowLayout, a.h.abc_search_dropdown_item_icons_2line);
    this.mSuggestionCommitIconResId = paramAttributeSet.getResourceId(a.k.SearchView_commitIcon, 0);
    ...
    this.mSearchSrcTextView.setOnFocusChangeListener(new bk(this));
    setIconifiedByDefault(paramAttributeSet.getBoolean(a.k.SearchView_iconifiedByDefault, true));
    paramInt = paramAttributeSet.getDimensionPixelSize(a.k.SearchView_android_maxWidth, -1);
    if (paramInt != -1) {
      setMaxWidth(paramInt);
    }
    this.mDefaultQueryHint = paramAttributeSet.getText(a.k.SearchView_defaultQueryHint);
    this.mQueryHint = paramAttributeSet.getText(a.k.SearchView_queryHint);
  ...
  {
    this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new bm(this));
  }
  
  @TargetApi(11)
  private void addOnLayoutChangeListenerToDropDownAnchorSDK11()
  {
    this.mDropDownAnchor.addOnLayoutChangeListener(new bl(this));
  }
  ...
  private Intent createIntentFromSuggestion(Cursor paramCursor, int paramInt, String paramString)
  {
    try
    {
      localObject2 = bv.a(paramCursor, "suggest_intent_action");
    ...
    localObject3 = bv.a(paramCursor, "suggest_intent_data");
    ...
    if (localObject1 != null)
    {
      str = bv.a(paramCursor, "suggest_intent_data_id");
      localObject3 = localObject1;
      if (str != null)
      {
        ...
        for (;;)
        {
          localObject3 = bv.a(paramCursor, "suggest_intent_query");
          return createIntent((String)localObject2, (Uri)localObject1, bv.a(paramCursor, "suggest_intent_extra_data"), (String)localObject3, paramInt, paramString);
  ...
  private void updateSearchAutoComplete()
  {
    ...
    if (this.mSearchable.getSuggestAuthority() != null)
    {
      this.mSuggestionsAdapter = new bv(getContext(), this, this.mSearchable, this.mOutsideDrawablesCache);
      this.mSearchSrcTextView.setAdapter(this.mSuggestionsAdapter);
      bv localbv = (bv)this.mSuggestionsAdapter;
      i = j;
  ...
  public void setQueryRefinementEnabled(boolean paramBoolean)
  {
    ...
    bv localbv;
    if ((this.mSuggestionsAdapter instanceof bv))
    {
      localbv = (bv)this.mSuggestionsAdapter;
      if (!paramBoolean) {
        break label35;
      }
    }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\android\support\v7\widget\SearchView.class
