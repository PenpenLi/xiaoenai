...
{
  private p mCompoundButtonHelper = new p(this, this.mDrawableManager);
  ...
  public int getCompoundPaddingLeft()
  {
    ...
    if (this.mCompoundButtonHelper != null) {
      i = this.mCompoundButtonHelper.a(j);
    }
    return i;
  }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\android\support\v7\widget\AppCompatRadioButton.class
