  ...
  extends FrameLayout
{
  ...
  public ActionBarContainer(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      this.mBackground = paramContext.getDrawable(a.k.ActionBar_background);
      this.mStackedBackground = paramContext.getDrawable(a.k.ActionBar_backgroundStacked);
      this.mHeight = paramContext.getDimensionPixelSize(a.k.ActionBar_height, -1);
      if (getId() == a.f.split_action_bar)
      {
        this.mIsSplit = true;
        this.mSplitBackground = paramContext.getDrawable(a.k.ActionBar_backgroundSplit);
      }
  ...
  public android.support.v7.view.b startActionModeForChild(View paramView, b.a parama)
  {
    return null;
  }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\android\support\v7\widget\ActionBarContainer.class
