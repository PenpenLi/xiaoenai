  ...
  implements NestedScrollingChild, ScrollingView
{
  ...
  private RecyclerView.ItemAnimator.a mItemAnimatorListener = new b(null);
  private Runnable mItemAnimatorRunner = new at(this);
  ...
  private final c mObserver = new c(null);
  ...
  private final Runnable mUpdateChildViewsRunnable = new as(this);
  private VelocityTracker mVelocityTracker;
  private final d mViewFlinger = new d();
  private final cg.b mViewInfoProcessCallback = new av(this);
  final cg mViewInfoStore = new cg();
  ...
  public RecyclerView(Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      {
        localObject = paramContext.obtainStyledAttributes(paramAttributeSet, a.c.RecyclerView, paramInt, 0);
        String str = ((TypedArray)localObject).getString(a.c.RecyclerView_layoutManager);
  ...
  private void dispatchLayoutStep1()
  {
    ...
    for (;;)
    {
      ...
      this.mViewInfoStore.a((ViewHolder)localObject, localItemHolderInfo);
      if ((this.mState.mTrackOldChangeHolders) && (((ViewHolder)localObject).isUpdated()) && (!((ViewHolder)localObject).isRemoved()) && (!((ViewHolder)localObject).shouldIgnore()) && (!((ViewHolder)localObject).isInvalid()))
      {
        ...
        this.mViewInfoStore.a(l, (ViewHolder)localObject);
      }
    }
    label279:
    if (this.mState.mRunPredictiveAnimations)
    {
      ...
      if (i < this.mChildHelper.b())
      {
        ...
        for (;;)
        {
          i += 1;
          break;
          if (!this.mViewInfoStore.d((ViewHolder)localObject))
          {
            ...
            if (bool) {
              ...
              this.mViewInfoStore.b((ViewHolder)localObject, localItemHolderInfo);
            }
          }
        }
      }
  ...
  private void dispatchLayoutStep3()
  {
    ...
    if (this.mState.mRunSimpleAnimations)
    {
      ...
      if (i >= 0)
      {
        ViewHolder localViewHolder1 = getChildViewHolderInt(this.mChildHelper.b(i));
        ...
        for (;;)
        {
          ...
          ViewHolder localViewHolder2 = this.mViewInfoStore.a(l);
          if ((localViewHolder2 != null) && (!localViewHolder2.shouldIgnore()))
          {
            boolean bool1 = this.mViewInfoStore.a(localViewHolder2);
            boolean bool2 = this.mViewInfoStore.a(localViewHolder1);
            if ((bool1) && (localViewHolder2 == localViewHolder1))
            {
              this.mViewInfoStore.c(localViewHolder1, localItemHolderInfo2);
            }
            else
            {
              RecyclerView.ItemAnimator.ItemHolderInfo localItemHolderInfo1 = this.mViewInfoStore.b(localViewHolder2);
              this.mViewInfoStore.c(localViewHolder1, localItemHolderInfo2);
              localItemHolderInfo2 = this.mViewInfoStore.c(localViewHolder1);
  ...
  private void findMinMaxChildLayoutPositions(int[] paramArrayOfInt)
  {
    ...
    if (k < i1)
    {
      localViewHolder = getChildViewHolderInt(this.mChildHelper.b(k));
  ...
  {
    this.mChildHelper = new z(new aw(this));
  }
  ...
  private void setDataSetChangedAfterLayout()
  {
    ...
    while (i < j)
    {
      ViewHolder localViewHolder = getChildViewHolderInt(this.mChildHelper.c(i));
      if ((localViewHolder != null) && (!localViewHolder.shouldIgnore())) {
  ...
  public boolean fling(int paramInt1, int paramInt2)
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      this.mViewFlinger.a(paramInt2, paramInt1);
      return true;
    }
  }
  ...
  {
    this.mAdapterHelper = new n(new ax(this));
  }
  ...
  void offsetPositionRecordsForMove(int paramInt1, int paramInt2)
  {
    ...
    for (int k = paramInt1;; k = paramInt2)
    {
      ...
      for (;;)
      {
        ...
        localViewHolder = getChildViewHolderInt(this.mChildHelper.c(m));
  ...
  public void smoothScrollBy(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (!this.mLayoutFrozen)
      {
        ...
        {
          this.mViewFlinger.b(paramInt1, paramInt2);
          return;
        }
      }
    }
  ...
  void viewRangeUpdate(int paramInt1, int paramInt2, Object paramObject)
  {
    ...
    if (i < j)
    {
      View localView = this.mChildHelper.c(i);
  ...
  public static abstract class ItemAnimator
  {
    ...
    public final void dispatchAnimationFinished(RecyclerView.ViewHolder paramViewHolder)
    {
      ...
      if (this.mListener != null) {
        this.mListener.a(paramViewHolder);
      }
    }
  ...
  public static abstract class LayoutManager
  {
    ...
    private void addViewInt(View paramView, int paramInt, boolean paramBoolean)
    {
      ...
      for (;;)
      {
        ...
        {
          int j = this.mChildHelper.b(paramView);
          int i = paramInt;
          if (paramInt == -1) {
    ...
    public View findContainingItemView(View paramView)
    {
      ...
      } while ((paramView == null) || (this.mChildHelper.c(paramView)));
      return paramView;
    }
    ...
    public View getChildAt(int paramInt)
    {
      if (this.mChildHelper != null) {
        return this.mChildHelper.b(paramInt);
      }
      return null;
    }
    ...
    public View getFocusedChild()
    {
      ...
      } while ((localView == null) || (this.mChildHelper.c(localView)));
      return localView;
    }
    ...
    RecyclerView.ViewHolder getScrapViewForPosition(int paramInt1, int paramInt2, boolean paramBoolean)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          localObject = RecyclerView.this.mChildHelper.a(paramInt1, paramInt2);
          if (localObject == null) {
            break label295;
          }
          localViewHolder = RecyclerView.getChildViewHolderInt((View)localObject);
          RecyclerView.this.mChildHelper.e((View)localObject);
          paramInt1 = RecyclerView.this.mChildHelper.b((View)localObject);
          if (paramInt1 != -1) {
            break;
          }
      ...
      RecyclerView.this.mChildHelper.d(paramInt1);
    ...
    View getViewForPosition(int paramInt, boolean paramBoolean)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          {
            k = RecyclerView.this.mAdapterHelper.b(paramInt);
          ...
          for (i = j;; i = k)
          {
            ...
            for (;;)
            {
              ...
              for (paramBoolean = bool;; paramBoolean = false)
              {
                ...
                j = RecyclerView.this.mAdapterHelper.b(paramInt);
    ...
    implements Runnable
  {
    private int b;
    private int c;
    private ScrollerCompat d = ScrollerCompat.create(RecyclerView.this.getContext(), RecyclerView.sQuinticInterpolator);
    ...
    public void a(int paramInt1, int paramInt2)
    {
      ...
      this.c = 0;
      this.b = 0;
      this.d.fling(0, 0, paramInt1, paramInt2, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE);
      a();
    }
    ...
    public void a(int paramInt1, int paramInt2, int paramInt3, Interpolator paramInterpolator)
    {
      if (this.e != paramInterpolator)
      {
        ...
        this.d = ScrollerCompat.create(RecyclerView.this.getContext(), paramInterpolator);
      }
      RecyclerView.this.setScrollState(2);
      this.c = 0;
      this.b = 0;
      this.d.startScroll(0, 0, paramInt1, paramInt2, paramInt3);
      a();
    }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\android\support\v7\widget\RecyclerView.class
