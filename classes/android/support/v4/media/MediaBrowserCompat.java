    ...
    implements MediaBrowserCompat.ConnectionCallback.ConnectionCallbackInternal, MediaBrowserCompat.MediaBrowserImpl, MediaBrowserCompat.MediaBrowserServiceCallbackImpl
  {
    ...
    public void getItem(@NonNull String paramString, @NonNull MediaBrowserCompat.ItemCallback paramItemCallback)
    {
      ...
      if (!MediaBrowserCompatApi21.isConnected(this.mBrowserObj))
      {
        ...
        this.mHandler.post(new MediaBrowserCompat.MediaBrowserImplApi21.1(this, paramItemCallback, paramString));
        return;
      }
      if (this.mServiceBinderWrapper == null)
      {
        this.mHandler.post(new MediaBrowserCompat.MediaBrowserImplApi21.2(this, paramItemCallback));
        return;
      }
      ...
      catch (RemoteException localRemoteException)
      {
        ...
        this.mHandler.post(new MediaBrowserCompat.MediaBrowserImplApi21.3(this, paramItemCallback, paramString));
      }
    }
    ...
    implements MediaBrowserCompat.MediaBrowserImpl, MediaBrowserCompat.MediaBrowserServiceCallbackImpl
  {
    ...
    public void getItem(@NonNull String paramString, @NonNull MediaBrowserCompat.ItemCallback paramItemCallback)
    {
      ...
      catch (RemoteException localRemoteException)
      {
        ...
        this.mHandler.post(new MediaBrowserCompat.MediaBrowserImplBase.3(this, paramItemCallback, paramString));
      }
    }
    ...
    extends MediaBrowserCompat.SubscriptionCallback
  {
      ...
      implements MediaBrowserCompatApi21.SubscriptionCallback
    {
      ...
      public void onChildrenLoaded(@NonNull String paramString, List<Parcel> paramList)
      {
        ...
        {
          MediaBrowserCompat.SubscriptionCallbackApi21.this.onChildrenLoaded(paramString, MediaBrowserCompatUtils.applyOptions(localArrayList, MediaBrowserCompat.SubscriptionCallbackApi21.this.mOptions), MediaBrowserCompat.SubscriptionCallbackApi21.this.mOptions);
          return;
        }
        MediaBrowserCompat.SubscriptionCallbackApi21.this.onChildrenLoaded(paramString, localArrayList);
      }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\android\support\v4\media\MediaBrowserCompat.class
