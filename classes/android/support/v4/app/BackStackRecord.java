  ...
  implements FragmentManager.BackStackEntry, Runnable
{
  ...
  private boolean configureTransitions(int paramInt, TransitionState paramTransitionState, boolean paramBoolean, SparseArray<Fragment> paramSparseArray1, SparseArray<Fragment> paramSparseArray2)
  {
    ...
    localObject4 = captureExitingViews(localObject5, (Fragment)localObject4, (ArrayList)localObject1, paramSparseArray1, paramTransitionState.nonExistentView);
    ...
    for (bool = ((Fragment)localObject2).getAllowReturnTransitionOverlap();; bool = ((Fragment)localObject2).getAllowEnterTransitionOverlap())
    {
      ...
      if (localObject2 != null)
      {
        FragmentTransitionCompat21.addTransitionTargets(localObject3, paramSparseArray2, localViewGroup, (FragmentTransitionCompat21.ViewRetriever)localObject5, paramTransitionState.nonExistentView, paramTransitionState.enteringEpicenterView, paramTransitionState.nameOverrides, localArrayList2, paramSparseArray1, localArrayMap, localArrayList1);
        ...
        FragmentTransitionCompat21.cleanupTransitions(localViewGroup, paramTransitionState.nonExistentView, localObject3, localArrayList2, localObject4, (ArrayList)localObject1, paramSparseArray2, localArrayList1, localObject2, paramTransitionState.hiddenFragmentViews, localArrayMap);
      }
      if (localObject2 == null) {
        break;
      }
    ...
    for (Object localObject2 = beginTransition((SparseArray)localObject1, (SparseArray)localObject2, false);; localObject2 = null)
    {
      ...
      for (;;)
      {
        ...
        if (this.mManager.mAdded != null)
        {
          ...
          if (n >= 0)
          {
            localObject3 = (Fragment)this.mManager.mAdded.get(n);
            if (FragmentManagerImpl.DEBUG) {
            ...
            for (;;)
            {
              ...
              localOp.removed.add(localObject3);
              ...
              this.mManager.removeFragment((Fragment)localObject3, j, i);
            }
          }
        }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\android\support\v4\app\BackStackRecord.class
