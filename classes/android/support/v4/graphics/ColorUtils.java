...
public final class ColorUtils
{
  ...
  @ColorInt
  public static int LABToColor(@FloatRange double paramDouble1, @FloatRange double paramDouble2, @FloatRange double paramDouble3)
  {
  ...
  public static void LABToXYZ(@FloatRange double paramDouble1, @FloatRange double paramDouble2, @FloatRange double paramDouble3, @NonNull double[] paramArrayOfDouble)
  {
  ...
  public static void RGBToHSL(@IntRange int paramInt1, @IntRange int paramInt2, @IntRange int paramInt3, @NonNull float[] paramArrayOfFloat)
  {
  ...
  public static void RGBToLAB(@IntRange int paramInt1, @IntRange int paramInt2, @IntRange int paramInt3, @NonNull double[] paramArrayOfDouble)
  {
  ...
  public static void RGBToXYZ(@IntRange int paramInt1, @IntRange int paramInt2, @IntRange int paramInt3, @NonNull double[] paramArrayOfDouble)
  {
  ...
  @ColorInt
  public static int XYZToColor(@FloatRange double paramDouble1, @FloatRange double paramDouble2, @FloatRange double paramDouble3)
  {
  ...
  public static void XYZToLAB(@FloatRange double paramDouble1, @FloatRange double paramDouble2, @FloatRange double paramDouble3, @NonNull double[] paramArrayOfDouble)
  {
    if (paramArrayOfDouble.length != 3) {
  ...
  @ColorInt
  public static int blendARGB(@ColorInt int paramInt1, @ColorInt int paramInt2, @FloatRange float paramFloat)
  {
  ...
  public static void blendHSL(@NonNull float[] paramArrayOfFloat1, @NonNull float[] paramArrayOfFloat2, @FloatRange float paramFloat, @NonNull float[] paramArrayOfFloat3)
  {
  ...
  public static void blendLAB(@NonNull double[] paramArrayOfDouble1, @NonNull double[] paramArrayOfDouble2, @FloatRange double paramDouble, @NonNull double[] paramArrayOfDouble3)
  {
  ...
  @ColorInt
  public static int setAlphaComponent(@ColorInt int paramInt1, @IntRange int paramInt2)
  {
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\android\support\v4\graphics\ColorUtils.class
