  ...
  implements Animatable
{
  ...
  private b(@Nullable Context paramContext)
  {
    this(paramContext, null, null);
  }
  
  private b(@Nullable Context paramContext, @Nullable a parama, @Nullable Resources paramResources)
  {
    this.c = paramContext;
    if (parama != null)
    {
  ...
  {
    if (this.a != null) {
      DrawableCompat.applyTheme(this.a, paramTheme);
    }
  }
    ...
    if (i != 1) {
      if (i == 2)
      {
        ...
        if (i != 0)
        {
          ...
          ((g)localObject2).setCallback(this.e);
          if (this.b.b != null) {
            this.b.b.setCallback(null);
          }
          this.b.b = ((g)localObject2);
        }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\android\support\a\a\b.class
