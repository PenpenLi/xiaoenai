  ...
  extends f
{
  ...
  @Nullable
  public static g a(@NonNull Resources paramResources, @DrawableRes int paramInt, @Nullable Resources.Theme paramTheme)
  {
    Object localObject;
    if (Build.VERSION.SDK_INT >= 23)
    {
      localObject = new g();
      ((g)localObject).a = ResourcesCompat.getDrawable(paramResources, paramInt, paramTheme);
      ((g)localObject).h = new g(((g)localObject).a.getConstantState());
  ...
  private void a(TypedArray paramTypedArray, XmlPullParser paramXmlPullParser)
  {
    ...
    locale.c = e.a(paramTypedArray, paramXmlPullParser, "viewportWidth", 7, locale.c);
    locale.d = e.a(paramTypedArray, paramXmlPullParser, "viewportHeight", 8, locale.d);
    if (locale.c <= 0.0F) {
    ...
    locale.a(e.a(paramTypedArray, paramXmlPullParser, "alpha", 4, locale.b()));
  ...
  public void inflate(Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme)
  {
    if (this.a != null)
    {
      DrawableCompat.inflate(this.a, paramResources, paramXmlPullParser, paramAttributeSet, paramTheme);
      return;
    }
    f localf = this.c;
    localf.b = new e();
    ...
    extends g.d
  {
    ...
    public void a(Resources paramResources, AttributeSet paramAttributeSet, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser)
    {
      ...
      paramResources = f.b(paramResources, paramTheme, paramAttributeSet, a.d);
      a(paramResources);
    ...
    extends g.d
  {
    ...
    public void a(Resources paramResources, AttributeSet paramAttributeSet, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser)
    {
      paramResources = f.b(paramResources, paramTheme, paramAttributeSet, a.c);
  ...
  private static class c
  {
    ...
    {
      this.l = null;
      this.c = e.a(paramTypedArray, paramXmlPullParser, "rotation", 5, this.c);
      this.d = paramTypedArray.getFloat(1, this.d);
      this.e = paramTypedArray.getFloat(2, this.e);
      this.f = e.a(paramTypedArray, paramXmlPullParser, "scaleX", 3, this.f);
      this.g = e.a(paramTypedArray, paramXmlPullParser, "scaleY", 4, this.g);
      this.h = e.a(paramTypedArray, paramXmlPullParser, "translateX", 6, this.h);
      this.i = e.a(paramTypedArray, paramXmlPullParser, "translateY", 7, this.i);
      paramTypedArray = paramTypedArray.getString(0);
      if (paramTypedArray != null) {
    ...
    public void a(Resources paramResources, AttributeSet paramAttributeSet, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser)
    {
      paramResources = f.b(paramResources, paramTheme, paramAttributeSet, a.b);
      a(paramResources, paramXmlPullParser);
      paramResources.recycle();
    }
  }
  ...
  private static class e
  {
    ...
    public e(e parame)
    {
      this.p = new g.c(parame.p, this.g);
    ...
    {
      g.c.b(paramc).set(paramMatrix);
      g.c.b(paramc).preConcat(g.c.c(paramc));
      int i1 = 0;
      if (i1 < paramc.a.size())
      {
        paramMatrix = paramc.a.get(i1);
        if ((paramMatrix instanceof g.c)) {
          a((g.c)paramMatrix, g.c.b(paramc), paramCanvas, paramInt1, paramInt2, paramColorFilter);
        }
        for (;;)
        {
          i1 += 1;
    ...
    public f(f paramf)
    {
      if (paramf != null)
      {
        ...
        if (g.e.b(paramf.b) != null) {
          g.e.a(this.b, new Paint(g.e.b(paramf.b)));
        }
        if (g.e.c(paramf.b) != null) {
          g.e.b(this.b, new Paint(g.e.c(paramf.b)));
        }
        this.c = paramf.c;
        this.d = paramf.d;
        this.e = paramf.e;
    ...
    extends Drawable.ConstantState
  {
    ...
    {
      g localg = new g(null);
      localg.a = ((VectorDrawable)this.a.newDrawable());
      return localg;
    }
    ...
    {
      g localg = new g(null);
      localg.a = ((VectorDrawable)this.a.newDrawable(paramResources));
      return localg;
    }
    ...
    {
      g localg = new g(null);
      localg.a = ((VectorDrawable)this.a.newDrawable(paramResources, paramTheme));
      return localg;
    }
  }
}
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\android\support\a\a\g.class
