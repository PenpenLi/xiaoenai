...
import com.handmark.pulltorefresh.library.internal.CustomListView;
  ...
  extends PullToRefreshAdapterViewBase<ListView>
{
  ...
  public CustomPullToRefreshListView(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  {
    return new CustomListView(paramContext, paramAttributeSet);
  }
  ...
  protected void onAttachedToWindow()
  {
    ...
    if (this.a != null) {
      ((ListView)this.a).setSelection(1);
    }
  }
}


/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\handmark\pulltorefresh\library\CustomPullToRefreshListView.class
