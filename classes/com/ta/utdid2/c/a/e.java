  ...
  private static final Object b(XmlPullParser paramXmlPullParser, String[] paramArrayOfString)
  {
    ...
    do
    {
      ...
      if (str2.equals("int-array"))
      {
        ...
        paramXmlPullParser = a(paramXmlPullParser, "int-array", paramArrayOfString);
        paramArrayOfString[0] = str1;
      ...
      {
        paramXmlPullParser.next();
        paramXmlPullParser = a(paramXmlPullParser, "list", paramArrayOfString);
        paramArrayOfString[0] = str1;
        return paramXmlPullParser;
      }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\ta\utdid2\c\a\e.class
