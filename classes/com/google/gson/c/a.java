  ...
  implements Closeable
{
  ...
  {
    throw new e(paramString + " at line " + v() + " column " + w() + " path " + q());
  }
  ...
  public double k()
  {
    ...
    do
    {
      for (;;)
      {
        ...
        throw new e("JSON forbids NaN and infinities: " + d1 + " at line " + v() + " column " + w() + " path " + q());
        if ((i1 == 8) || (i1 == 9))
        {
          if (i1 == 8) {}
          for (char c1 = '\'';; c1 = '"')
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\google\gson\c\a.class
