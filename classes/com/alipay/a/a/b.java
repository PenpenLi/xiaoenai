  ...
  implements i, j
{
  ...
  {
    int i = 0;
    if (!paramObject.getClass().equals(org.a.a.b.class)) {
      return null;
    }
    Object localObject = a.a(paramType);
    paramObject = (org.a.a.b)paramObject;
    localObject = a((Class)localObject, paramType);
    if ((paramType instanceof ParameterizedType))
    {
      paramType = ((ParameterizedType)paramType).getActualTypeArguments()[0];
      while (i < ((org.a.a.b)paramObject).a())
      {
        ((Collection)localObject).add(e.a(((org.a.a.b)paramObject).a(i), paramType));
        i += 1;
      }
    }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\alipay\a\a\b.class
