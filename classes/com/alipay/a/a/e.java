...
public final class e
{
  ...
  public static final Object a(String paramString, Type paramType)
  {
    ...
    if ((paramString.startsWith("[")) && (paramString.endsWith("]"))) {
      return a(new org.a.a.b(paramString), paramType);
    }
    if ((paramString.startsWith("{")) && (paramString.endsWith("}"))) {
      return a(new org.a.a.c(paramString), paramType);
    }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\alipay\a\a\e.class
