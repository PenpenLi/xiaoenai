  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        this.b = MotionEvent.obtain(paramMotionEvent).getX();
      }
    } while (Math.abs(paramMotionEvent.getX() - this.b) <= this.a);
    return false;
  }
}


/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\marshalchen\ultimaterecyclerview\ui\VerticalSwipeRefreshLayout.class
