...
{
  public static final aj a = new a().a().c();
  public static final aj b = new a().b().a(Integer.MAX_VALUE, TimeUnit.SECONDS).c();
  String c;
  ...
  private aj(boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, int paramInt3, int paramInt4, boolean paramBoolean6, boolean paramBoolean7, String paramString)
  {
  ...
  public static aj a(ba paramba)
  {
    ...
    while (i7 < i13)
    {
      Object localObject2 = paramba.a(i7);
      String str1 = paramba.b(i7);
      int i8;
      ...
      for (;;)
      {
        ...
        {
          i6 = do.b((String)localObject2, -1);
          i8 = i2;
        }
        else if ("s-maxage".equalsIgnoreCase(str2))
        {
          i5 = do.b((String)localObject2, -1);
          i8 = i2;
        }
        ...
        {
          i4 = do.b((String)localObject2, Integer.MAX_VALUE);
          i8 = i2;
        }
        else if ("min-fresh".equalsIgnoreCase(str2))
        {
          i3 = do.b((String)localObject2, -1);
          i8 = i2;
        }
    ...
    if (i1 == 0) {}
    for (paramba = null;; paramba = (ba)localObject1) {
      return new aj(bool1, bool5, i6, i5, bool7, bool6, bool4, i4, i3, bool3, bool2, paramba);
    }
  }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\adhoc\aj.class
