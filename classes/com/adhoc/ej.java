  ...
  implements HostnameVerifier
{
  ...
  private boolean c(String paramString, X509Certificate paramX509Certificate)
  {
    ...
    if (i == 0)
    {
      paramX509Certificate = paramX509Certificate.getSubjectX500Principal();
      try
      {
        paramX509Certificate = new ei(paramX509Certificate).a("cn");
        if (paramX509Certificate != null)
        {
          boolean bool = a(paramString, paramX509Certificate);
          return bool;
        }
      }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\adhoc\ej.class
