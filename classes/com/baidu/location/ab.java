  ...
  implements LLSInterface, ax, n
{
  ...
  public IBinder onBind(Intent paramIntent)
  {
    ...
    if (paramIntent != null)
    {
      ...
      this.gx = paramIntent.getBoolean("kill_process");
      gE = paramIntent.getBoolean("debug_dev");
      gw = paramIntent.getLong("interval");
    }
    if (!bool) {
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\baidu\location\ab.class
