...
public abstract interface BDGeofence
{
  ...
  public static final class Builder
  {
    ...
    private long jdField_if = Long.MIN_VALUE;
    ...
    public BDGeofence build()
    {
      ...
      if (this.jdField_if == Long.MIN_VALUE) {
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\baidu\location\BDGeofence.class
