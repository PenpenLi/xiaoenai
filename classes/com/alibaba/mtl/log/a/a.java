...
public class a
{
  ...
  static
  {
    Q = "http://m-adash.m.taobao.com/rest/sur";
    R = "http://adashbc.m.taobao.com/rest/sur";
    z = false;
    A = false;
    B = false;
    C = false;
  ...
  public static List<String> a(String paramString)
  {
    ...
    catch (Exception paramString)
    {
      ...
      if ((m == 1) || (m == 61005) || (m == 61006) || (m == 65501) || (m == 65502) || (m == 65503) || (m == 65133)) {
        return g;
      }
      if (((m > 1) && (m < 100)) || ((m > 15300) && (m < 15400)) || ((m > 21000) && (m < 30000)) || ((m > 61000) && (m < 61200)) || ((m > 65000) && (m < 65300))) {
        return h;
      }
      if ((m > 1000) && (m < 2100)) {
        return i;
      ...
      if ((m == 19999) || ((m > 4000) && (m < 10000)) || ((m > 64000) && (m < 65000)) || ((m > 65500) && (m < 65600)) || ((m > 66000) && (m < 67000))) {
        return f;
      }
    }
    return k;
  ...
  public static String g()
  {
    ...
    {
      i.a("Config", new Object[] { T, "l0 config" });
      return "{\"SYSTEM\":{\"discardap\":\"1\"}}";
    }
    if ("l1".equalsIgnoreCase(T))
    {
      i.a("Config", new Object[] { T, "l1 config" });
    ...
    {
      i.a("Config", new Object[] { T, "l2 config" });
    ...
    {
      i.a("Config", new Object[] { T, "l3 config" });
    ...
    i.a("Config", new Object[] { T, "net config" });
    return f();
  }
  ...
  {
    i.a("Config", new Object[] { "[setForeGroundUploadIntervalByOrange]1:", paramString });
    int m = b(paramString);
    if (m == -1)
    {
      B = false;
    ...
    d = m;
    i.a("Config", new Object[] { "[setForeGroundUploadIntervalByOrange]2:", Long.valueOf(d) });
    B = true;
  }
  ...
  {
    i.a("Config", new Object[] { "[setBackGroundUploadIntervalByOrange]:", paramString });
    int m = b(paramString);
    if (m == -1) {
      return;
    }
  ...
  {
    SharedPreferences.Editor localEditor = PreferenceManager.getDefaultSharedPreferences(com.alibaba.mtl.log.a.getContext()).edit();
    localEditor.putString("MOTU_APPMONITOR_CONFIG", paramString);
    localEditor.apply();
  }
  ...
  public static void turnOnRealTimeDebug(Map<String, String> paramMap)
  {
    ...
    if (paramMap != null)
    {
      String str1 = (String)paramMap.get("debug_api_url");
      String str2 = (String)paramMap.get("debug_key");
      ...
      {
        com.alibaba.mtl.appmonitor.AppMonitorDelegate.IS_DEBUG = true;
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\alibaba\mtl\log\a\a.class
