...
{
  private static void normalize(String paramString1, String paramString2, Set<String> paramSet, Map<String, Set<String>> paramMap)
  {
    ...
    for (;;)
    {
      ...
      while (paramString2.hasNext())
      {
        ...
        if (paramSet.add(str)) {
          normalize(paramString1, str, paramSet, paramMap);
        }
      }
    }
  }
  
  public static void sorts(SortInfo[] paramArrayOfSortInfo)
  {
    HashMap localHashMap2 = new HashMap();
    HashMap localHashMap1 = new HashMap();
    int k = paramArrayOfSortInfo.length;
    int i = 0;
    Object localObject4;
    Object localObject5;
    while (i < k)
    ...
    while (i < j)
    {
      ...
      normalize(((SortInfo)localObject2).name, ((SortInfo)localObject2).name, (Set)localObject1, localHashMap2);
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\alibaba\sdk\android\util\SortUtils.class
