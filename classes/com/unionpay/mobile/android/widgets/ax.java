  ...
  extends RelativeLayout
{
  ...
  private void b(String paramString)
  {
    ...
    int n = d.a(this.a, 20.0F);
    int m = d.a(this.a, 11.0F);
    if (this.h != 0) {
      m = this.h;
    }
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(null))
      {
        ...
        paramString.addRule(15, -1);
        paramString.rightMargin = m;
        addView(new o(this.a, a.M, 1), paramString);
      }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\unionpay\mobile\android\widgets\ax.class
