  ...
  extends RelativeLayout
{
  ...
  public m(Context paramContext)
  {
    super(paramContext);
    this.a = paramContext;
    int i = d.a(paramContext, 10.0F);
    setPadding(i, i, i, i);
    setBackgroundColor(-1);
    setOnClickListener(new n(this));
    int j = d.a(paramContext, 15.0F);
  ...
  public final void a(boolean paramBoolean, JSONArray paramJSONArray, JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      {
        h.c("uppay", "init order detail = null!!!");
        return;
        i = 1;
        break;
      ...
      this.d = bg.a(this.a, paramJSONArray, i, j);
      if (paramJSONObject != null)
      {
        paramJSONArray = new ac(this.a, paramJSONObject);
        paramJSONArray.f();
        paramJSONArray.a(b.m);
        paramJSONObject = new LinearLayout.LayoutParams(-1, -2);
        paramJSONObject.topMargin = d.a(this.a, 8.0F);
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\unionpay\mobile\android\views\order\m.class
