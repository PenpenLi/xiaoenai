    ...
    for (;;)
    {
      try
      {
        ...
        if (l < i)
        {
          ...
          localObject3 = b.b[i];
          localObject4 = b.c[i];
          localObject1 = e.a(j, (int[])localObject1, (float[])localObject3, localObject4[0], localObject4[1], localObject4[2], localObject4[3]);
          break label119;
          localObject1 = b.a[i];
          localObject1 = e.a(a(localObject1[0], paramInt2, paramInt3), a(localObject1[1], paramInt2, paramInt3), a(localObject1[2], paramInt2, paramInt3), a(localObject1[3], paramInt2, paramInt3));
          break label119;
          localObject1 = e.a(b.f[i], b.g[i], b.h[i]);
          break label119;
        }
      ...
      h.a("img", "w=" + paramInt2 + ",h=" + paramInt3);
      localObject5 = Bitmap.createScaledBitmap((Bitmap)localObject1, paramInt2, paramInt3, true);
      if (localObject5 != localObject1) {
        ((Bitmap)localObject1).recycle();
      }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\unionpay\mobile\android\resource\c.class
