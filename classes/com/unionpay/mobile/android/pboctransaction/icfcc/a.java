  ...
  implements com.unionpay.mobile.android.pboctransaction.c
{
  ...
  private byte[] a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        str = e.a(paramArrayOfByte, paramArrayOfByte.length);
      ...
      h.c("icfcc", " openSEChannel result=" + e.a(paramArrayOfByte));
  ...
  public final ArrayList<com.unionpay.mobile.android.model.c> a(d paramd)
  {
    ...
    try
    {
      ...
      h.c("icfcc", "aid =" + (String)localObject);
      if (localObject != null)
      {
  ...
  public final byte[] a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    try
    {
      ...
      h.c("icfcc", "<====" + e.a(paramArrayOfByte));
      return paramArrayOfByte;
    }
    catch (Exception paramArrayOfByte)
    {
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\unionpay\mobile\android\pboctransaction\icfcc\a.class
