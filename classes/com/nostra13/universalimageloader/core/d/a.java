  ...
  implements b
{
  ...
  protected InputStream d(String paramString, Object paramObject)
  {
    ...
    return new com.nostra13.universalimageloader.core.a.a(new BufferedInputStream(new FileInputStream((String)paramObject), 32768), (int)new File((String)paramObject).length());
  }
