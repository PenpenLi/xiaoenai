  ...
  implements CmdExecutor<AppInstallCmd>
{
  ...
  private static boolean needActivate(Context paramContext, AppInstallCmd paramAppInstallCmd)
  {
    ...
    if (localList.contains("com.sina.weibo"))
    {
      ...
      return (paramContext == null) || (!paramContext.isLegal());
    }
  ...
  private static Pair<Integer, File> walkDir(Context paramContext, String paramString, AppInstallCmd paramAppInstallCmd)
  {
    ...
    if ((((File)localObject1).isFile()) && (((String)localObject2).endsWith(".apk")))
    {
      localObject2 = paramContext.getPackageManager().getPackageArchiveInfo(((File)localObject1).getAbsolutePath(), 64);
    ...
    for (;;)
    {
      j += 1;
      break;
      if (((PackageInfo)localObject2).versionCode > i)
      {
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\sina\weibo\sdk\cmd\AppInstallCmdExecutor.class
