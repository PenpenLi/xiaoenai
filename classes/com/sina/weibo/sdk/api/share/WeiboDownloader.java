...
public class WeiboDownloader
{
  ...
  public static Dialog createDownloadConfirmDialog(Context paramContext, IWeiboDownloadListener paramIWeiboDownloadListener)
  {
    ...
    return new AlertDialog.Builder(paramContext).setMessage(str3).setTitle(str4).setPositiveButton(str2, new WeiboDownloader.1(paramContext)).setNegativeButton(str1, new WeiboDownloader.2(paramIWeiboDownloadListener)).create();
  }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\sina\weibo\sdk\api\share\WeiboDownloader.class
