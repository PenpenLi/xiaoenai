  ...
  extends View
{
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      paramCanvas.drawText(str, (getMeasuredWidth() - i1) / 2, n + (k * j + m + i), this.mPaint);
      c2 = c1;
      j += 1;
      c1 = c2;
      break;
    ...
    if ((this.mNeedIndex == null) || (this.mNeedIndex[j] != 0))
    {
      ...
      this.mSeatchIcon.setBounds(n, k - n, m + n, k + m - n);
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\sina\weibo\sdk\register\mobile\LetterIndexBar.class
