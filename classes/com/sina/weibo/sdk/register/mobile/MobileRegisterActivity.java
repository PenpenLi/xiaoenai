...
public class MobileRegisterActivity
  extends Activity
  implements View.OnClickListener, View.OnFocusChangeListener, ResizeableLayout.SizeChangeListener
{
  ...
  private void initView()
  {
    ...
    this.titleBar.setTitleBarClickListener(new MobileRegisterActivity.2(this));
  ...
  public void getMsg(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      NetUtils.internalHttpRequest(this, "http://api.weibo.com/oauth2/sms_authorize/send", localWeiboParameters, "GET", new MobileRegisterActivity.3(this));
      return;
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    initView();
    this.mCountDownTimer = new MobileRegisterActivity.1(this, 60000L, 1000L);
  }
  ...
  public void submit(String paramString1, String paramString2)
  {
    ...
    NetUtils.internalHttpRequest(this, "http://api.weibo.com/oauth2/sms_authorize/submit", localWeiboParameters, "GET", new MobileRegisterActivity.4(this, paramString1));
  }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\sina\weibo\sdk\register\mobile\MobileRegisterActivity.class
