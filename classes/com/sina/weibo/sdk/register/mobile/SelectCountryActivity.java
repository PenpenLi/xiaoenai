  ...
  implements LetterIndexBar.OnIndexChangeListener
{
  ...
  private void initView()
  {
    ...
    ((TitleBar)localObject).setTitleBarClickListener(new SelectCountryActivity.1(this));
    ...
    this.mListView.setOnItemClickListener(new SelectCountryActivity.2(this));
    ...
    extends BaseAdapter
  {
    ...
    public Object getItem(int paramInt)
    {
      ...
      if (paramInt == SelectCountryActivity.this.indexCountries.size()) {
        return null;
      }
      SelectCountryActivity.IndexCountry localIndexCountry = (SelectCountryActivity.IndexCountry)SelectCountryActivity.this.indexCountries.get(paramInt);
      if (localIndexCountry.indexInList == -1) {
        return null;
      }
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      if ((paramView instanceof SelectCountryTitleView)) {
        return new SelectCountryItemView(SelectCountryActivity.this, paramViewGroup.getName(), paramViewGroup.getCode());
      }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\sina\weibo\sdk\register\mobile\SelectCountryActivity.class
