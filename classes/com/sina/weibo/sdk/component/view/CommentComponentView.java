...
public class CommentComponentView
  extends FrameLayout
{
  ...
  private void init(Context paramContext)
  {
    ...
    ((TextView)localObject).setTextColor(33280);
    ...
    ((TextView)localObject).setOnClickListener(new CommentComponentView.1(this));
  }
  ...
  public static enum Category
  {
    ...
    private Category(String paramString1)
    {
      this.mVal = paramString1;
    }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\sina\weibo\sdk\component\view\CommentComponentView.class
