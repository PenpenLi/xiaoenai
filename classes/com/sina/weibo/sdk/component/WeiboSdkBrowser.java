  ...
  implements BrowserRequestCallBack
{
  ...
  private BrowserRequestParamBase createBrowserRequestParam(Bundle paramBundle)
  {
    ...
    Object localObject = (BrowserLauncher)paramBundle.getSerializable("key_launcher");
    if (localObject == BrowserLauncher.AUTH)
    {
    ...
    if (localObject == BrowserLauncher.SHARE)
    {
    ...
    if (localObject == BrowserLauncher.WIDGET)
    {
    ...
    if (localObject == BrowserLauncher.GAME)
    {
      this.isFromGame = Boolean.valueOf(true);
      localObject = new GameRequestParam(this);
      ((GameRequestParam)localObject).setupRequestParam(paramBundle);
      installWeiboWebGameClient((GameRequestParam)localObject);
      return (BrowserRequestParamBase)localObject;
    }
    return null;
  }
  ...
  {
    paramGameRequestParam = new WeiboGameClient(this, paramGameRequestParam);
    paramGameRequestParam.setBrowserRequestCallBack(this);
    this.mWeiboWebViewClient = paramGameRequestParam;
  }
  ...
  private void setContentView()
  {
    ...
    this.mLoadErrorRetryBtn.setOnClickListener(new WeiboSdkBrowser.3(this));
  ...
  private void setTopNavTitle()
  {
    ...
    this.mLeftBtn.setOnClickListener(new WeiboSdkBrowser.2(this));
  }
  ...
  private void startShare()
  {
    ...
    ShareRequestParam localShareRequestParam = (ShareRequestParam)this.mRequestParam;
    if (localShareRequestParam.hasImage())
    {
      ...
      new AsyncWeiboRunner(this).requestAsync("http://service.weibo.com/share/mobilesdk_uppic.php", localWeiboParameters, "POST", new WeiboSdkBrowser.1(this, localShareRequestParam));
      return;
    }
    openUrl(this.mUrl);
  }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\sina\weibo\sdk\component\WeiboSdkBrowser.class
