...
public class WBAgent
{
  ...
  public static void onEvent(Object paramObject, String paramString, Map<String, String> paramMap)
  {
    ...
    for (;;)
    {
      WBAgentHandler.getInstance().onEvent((String)paramObject, paramString, paramMap);
      return;
    }
  }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\sina\weibo\sdk\statistic\WBAgent.class
