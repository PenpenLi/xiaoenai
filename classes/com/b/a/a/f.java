  ...
  implements s
{
  ...
  protected void handleMessage(Message paramMessage)
  {
    ...
    a.a.d("AsyncHttpRH", "SUCCESS_MESSAGE didn't got enough params");
    return;
    paramMessage = (Object[])paramMessage.obj;
    ...
    a.a.d("AsyncHttpRH", "FAILURE_MESSAGE didn't got enough params");
    return;
    onStart();
    return;
    onFinish();
    ...
    a.a.d("AsyncHttpRH", "PROGRESS_MESSAGE didn't got enough params");
    return;
    paramMessage = (Object[])paramMessage.obj;
    ...
    a.a.d("AsyncHttpRH", "RETRY_MESSAGE didn't get enough params");
    return;
    onCancel();
    return;
  }
  ...
  public void onPostProcessResponse(s params, HttpResponse paramHttpResponse) {}
  
  public void onPreProcessResponse(s params, HttpResponse paramHttpResponse) {}
  ...
  public void onProgress(long paramLong1, long paramLong2)
  {
    ...
    {
      localk.a("AsyncHttpRH", String.format("Progress %d from %d (%2.0f%%)", new Object[] { Long.valueOf(paramLong1), Long.valueOf(paramLong2), Double.valueOf(d) }));
      return;
    }
  }
  ...
  public void setUseSynchronousMode(boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      ...
      {
        bool = true;
        a.a.c("AsyncHttpRH", "Current thread has not called Looper.prepare(). Forcing synchronous mode.");
      }
    }
    if ((!bool) && (this.handler == null)) {}
    for (this.handler = new a(this, this.looper);; this.handler = null) {
      do
      {
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\com\b\a\a\f.class
