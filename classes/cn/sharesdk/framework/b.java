  ...
  implements PlatformActionListener
{
  ...
  public void onComplete(Platform paramPlatform, int paramInt, HashMap<String, Object> paramHashMap)
  {
    ...
    for (String str = paramPlatform.getDb().get("name");; str = paramPlatform.getDb().getUserId())
    {
      ...
      cn.sharesdk.framework.statistics.d.a(paramPlatform.getContext(), localb.g).a(localb);
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\cn\sharesdk\framework\b.class
