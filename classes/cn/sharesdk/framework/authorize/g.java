  ...
  implements Handler.Callback, ResizeLayout.OnResizeListener
{
  ...
  public void onCreate()
  {
    ...
    try
    {
      i = com.mob.tools.b.g.b(getContext(), "ssdk_" + str.toLowerCase());
    ...
    catch (Throwable localThrowable2)
    {
      for (;;)
      {
        try
        {
          int i = com.mob.tools.b.g.b(getContext(), "ssdk_weibo_oauth_regiseter");
          ((TitleLayout)localObject).getTvTitle().setText(i);
        }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\cn\sharesdk\framework\authorize\g.class
