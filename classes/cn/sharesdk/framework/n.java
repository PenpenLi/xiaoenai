  ...
  extends f
{
  ...
  private boolean a(a parama, HashMap<String, Object> paramHashMap1, HashMap<String, Object> paramHashMap2)
  {
    try
    {
      ...
      {
        cn.sharesdk.framework.utils.d.a().w("ShareSDK parse sns config ==>>", new Object[] { new e().a(paramHashMap1) });
        return false;
      }
    ...
    {
      cn.sharesdk.framework.utils.d.a().w(parama);
    }
    return false;
  }
  ...
  private void l()
  {
    l locall = new l(this.b, this.j);
    locall.a(this);
    locall.a(this.handler, this.k, c());
  }
  ...
  public String a(int paramInt, String paramString)
  {
    synchronized (this.h)
    {
      paramString = new l(this.b, this.j).a(paramInt, paramString, this.h);
      return paramString;
    }
  }
  ...
  public String a(Bitmap paramBitmap)
  {
    ...
    return new l(this.b, this.j).a(paramBitmap);
  }
  ...
  public String a(String paramString1, boolean paramBoolean, int paramInt, String paramString2)
  {
    ...
    return new l(this.b, this.j).a(paramString1, paramBoolean, paramInt, paramString2);
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    synchronized (this.h)
    {
      new l(this.b, this.j).a(paramInt1, paramInt2, this.h);
      return;
    }
  }
  ...
  {
    new l(this.b, this.j).a(paramInt, paramPlatform);
  }
  ...
  public void a(Class<? extends Service> paramClass)
  {
    ...
    catch (Throwable paramClass)
    {
      for (;;)
      {
        cn.sharesdk.framework.utils.d.a().w(paramClass);
      }
    }
  }
  ...
  {
    new l(this.b, this.j).a(paramString, paramInt);
  }
  ...
  public boolean a(HashMap<String, Object> paramHashMap)
  {
    ...
    a locala = a.a(this.b, this.j);
    boolean bool2 = a(locala, locala.f(), paramHashMap);
    if (bool2)
    {
      this.n = true;
      new p(this, locala).start();
      return bool2;
    }
    boolean bool1 = bool2;
    try
    {
      HashMap localHashMap = locala.g();
      bool1 = bool2;
  ...
  public Platform[] a()
  {
    ...
    cn.sharesdk.framework.utils.d.a().i("sort list use time: %s", new Object[] { Long.valueOf(System.currentTimeMillis() - l1) });
  ...
  public String b()
  {
    try
    {
      String str = new l(this.b, this.j).c();
      return str;
    }
    catch (Throwable localThrowable)
    {
  ...
  public boolean b(HashMap<String, Object> paramHashMap)
  {
    ...
    {
      this.h.clear();
      boolean bool = new l(this.b, this.j).a(paramHashMap, this.h);
      return bool;
    }
  }
  ...
  public String c(String paramString)
  {
    ...
    return new l(this.b, this.j).a(paramString);
  }
  ...
  public void d(Class<? extends CustomPlatform> arg1)
  {
    ...
    for (;;)
    {
      ...
      catch (Throwable ???)
      {
        ...
        cn.sharesdk.framework.utils.d.a().w(???);
        continue;
      }
      synchronized (this.e)
      {
  ...
  public void startThread()
  {
    this.a = a.b;
    h();
    cn.sharesdk.framework.utils.d.a(this.b, 60058, this.j);
    super.startThread();
  }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\cn\sharesdk\framework\n.class
