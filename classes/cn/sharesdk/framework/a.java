  ...
  private String a(PlatformDb paramPlatformDb, String[] paramArrayOfString)
  {
    ...
    if (i < k)
    {
      ...
      for (;;)
      {
        ...
        localStringBuilder2.append(com.mob.tools.b.b.c(str, "utf-8"));
      }
    }
      ...
      try
      {
        ...
        if (localShareParams != null)
        {
          ...
          if ((("WechatMoments".equals(paramPlatform.getName())) || ("WechatFavorite".equals(paramPlatform.getName()))) && (TextUtils.isEmpty((CharSequence)localObject1)))
          {
            ...
            cn.sharesdk.framework.statistics.d.a(paramPlatform.getContext(), localf.g).a(localf);
          }
        }
        else if (this.a == null) {}
      }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\cn\sharesdk\framework\a.class
