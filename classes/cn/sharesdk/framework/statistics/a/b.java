...
public class b
{
  ...
  public int a(String paramString1, String paramString2, String[] paramArrayOfString)
  {
    ...
    catch (Exception paramString2)
    {
      try
      {
        cn.sharesdk.framework.utils.d.a().d("Deleted %d rows from table: %s", new Object[] { Integer.valueOf(i), paramString1 });
        return i;
      }
      catch (Exception paramString2)
      {
    ...
    cn.sharesdk.framework.utils.d.a().w(paramString2, "when delete database occur error table:%s,", tmp61_58);
    return i;
  }
  ...
  public long a(String paramString, ContentValues paramContentValues)
  {
    ...
    {
      cn.sharesdk.framework.utils.d.a().w(paramContentValues, "when insert database occur error table:%s,", new Object[] { paramString });
    }
    return -1L;
  }
  ...
  public Cursor a(String paramString1, String[] paramArrayOfString1, String paramString2, String[] paramArrayOfString2, String paramString3)
  {
    ...
    {
      cn.sharesdk.framework.utils.d.a().w(paramArrayOfString1, "when query database occur error table:%s,", new Object[] { paramString1 });
    }
    return null;
  }
}
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\cn\sharesdk\framework\statistics\a\b.class
