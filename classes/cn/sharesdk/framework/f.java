...
public class f
{
    ...
    for (;;)
    {
      try
      {
        ...
        if (!ShareSDK.b((HashMap)localObject))
        {
          ...
          cn.sharesdk.framework.utils.d.a().w("Failed to parse network dev-info: " + (String)localObject, new Object[0]);
          return false;
        }
        localObject = a(this.a.getPlatformId(), "covert_url", null);
        if (localObject != null) {
  ...
  private String k()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        cn.sharesdk.framework.utils.d.a().i("user id %s ==>>", new Object[] { g().getUserName() });
        localStringBuilder.append(b.c(g().getUserName(), "utf-8"));
        localStringBuilder.append("|").append(b.c(g().get("secretType"), "utf-8"));
        localStringBuilder.append("|").append(b.c(g().get("gender"), "utf-8"));
        localStringBuilder.append("|").append(b.c(g().get("birthday"), "utf-8"));
        localStringBuilder.append("|").append(b.c(g().get("educationJSONArrayStr"), "utf-8"));
        localStringBuilder.append("|").append(b.c(g().get("workJSONArrayStr"), "utf-8"));
      }
      catch (Throwable localThrowable)
      {
        cn.sharesdk.framework.utils.d.a().w(localThrowable);
      ...
      localStringBuilder.append(b.c(g().getUserId(), "utf-8"));
    }
  }
  ...
  public void a(String paramString)
  {
    ...
    try
    {
      this.e = com.mob.tools.b.g.d(String.valueOf(str).trim());
    ...
    catch (Throwable localThrowable1)
    {
      try
      {
        do
        {
          this.f = com.mob.tools.b.g.d(String.valueOf(str).trim());
      ...
      for (;;)
      {
        if (paramInt < j)
        {
          ...
          catch (Throwable paramObject)
          {
            for (;;)
            {
              cn.sharesdk.framework.utils.d.a().w((Throwable)paramObject);
              paramObject = null;
            }
          }
        }
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\cn\sharesdk\framework\f.class
