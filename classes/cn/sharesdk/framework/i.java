  ...
  extends WebViewClient
{
  ...
  public void onReceivedSslError(WebView paramWebView, SslErrorHandler paramSslErrorHandler, SslError paramSslError)
  {
    if ((paramWebView.getContext() instanceof Activity))
    {
      ...
      String str2;
      String str1;
      if ("zh".equals(c.a((Context)localObject).n()))
      {
      ...
      for (;;)
      {
        ...
        ((AlertDialog.Builder)localObject).setPositiveButton(str1, new j(this, paramSslErrorHandler));
        ((AlertDialog.Builder)localObject).setNegativeButton(paramWebView, new k(this, paramSslErrorHandler));
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\cn\sharesdk\framework\i.class
