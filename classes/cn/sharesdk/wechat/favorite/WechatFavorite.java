  ...
  extends Platform
{
    ...
    do
    {
      ...
      for (;;)
      {
        if (i < arrayOfInt.length) {
          try
          {
            arrayOfInt[i] = com.mob.tools.b.g.d(arrayOfString[i]);
            i += 1;
          }
  ...
  protected void doAuthorize(String[] paramArrayOfString)
  {
    ...
    do
    {
      ...
      this.listener.onError(this, 1, new WechatTimelineNotSupportedException());
      return;
      cn.sharesdk.wechat.utils.g localg = new cn.sharesdk.wechat.utils.g(this, 37);
  ...
  protected void userInfor(String paramString)
  {
    ...
    {
      return;
      paramString = new cn.sharesdk.wechat.utils.g(this, 37);
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\cn\sharesdk\wechat\favorite\WechatFavorite.class
