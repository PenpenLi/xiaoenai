...
public class k
{
  ...
  public void a(WechatResp paramWechatResp)
  {
    ...
    default: 
      ...
      new Throwable(new e().a((HashMap)localObject)).printStackTrace();
    }
    do
    {
      do
      {
        do
        {
          ...
          ((HashMap)localObject).put("errStr", paramWechatResp.g);
          ((HashMap)localObject).put("transaction", paramWechatResp.h);
          localObject = new Throwable(new e().a((HashMap)localObject));
          switch (paramWechatResp.a())
          {
          default: 
            return;
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\cn\sharesdk\wechat\utils\k.class
