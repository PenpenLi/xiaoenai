  ...
  extends Platform
{
  ...
  private void a(Platform.ShareParams paramShareParams)
  {
    ...
    try
    {
      ...
      {
        paramShareParams.setImagePath(com.mob.tools.b.a.a(this.context, str));
  ...
  private void b(Platform.ShareParams paramShareParams)
  {
    for (;;)
    {
      ...
      f.a(this).a(str3, str1, (String)localObject2, (String)localObject1, str4, this.b, new c(this, paramShareParams));
      return;
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {
        continue;
      }
      localObject1 = uploadImageToFileServer((String)localObject2);
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\cn\sharesdk\tencent\qzone\QZone.class
