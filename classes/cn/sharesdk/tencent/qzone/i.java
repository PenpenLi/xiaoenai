  ...
  extends a
{
  ...
  private void b(String paramString)
  {
    ...
    this.g = true;
    finish();
    this.c.onComplete(null, 0, new e().a(paramString));
  }
  ...
  private void c()
  {
    try
    {
      ...
      a.registerExecutor(this.f, this);
      finish();
      return;
    }
    catch (Throwable localThrowable)
  ...
  private void d()
  {
    ...
    try
    {
      int j = g.b(getContext(), "ssdk_share_to_qzone");
      if (j > 0) {
    ...
    if ("none".equals(c.a(this.activity).u()))
    {
      this.h = true;
      finish();
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\cn\sharesdk\tencent\qzone\i.class
