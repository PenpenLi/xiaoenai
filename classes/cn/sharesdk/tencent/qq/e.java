  ...
  extends cn.sharesdk.framework.e
{
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, PlatformActionListener paramPlatformActionListener)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramString4 = com.mob.tools.b.c.a(this.a.getContext());
        paramString5.append("status_os=").append(com.mob.tools.b.b.c(paramString4.m(), "utf-8")).append("&");
        paramString5.append("status_machine=").append(com.mob.tools.b.b.c(paramString4.d(), "utf-8")).append("&");
        paramString5.append("status_version=").append(com.mob.tools.b.b.c(String.valueOf(paramString4.l()), "utf-8")).append("&");
        paramString4 = paramString4.y();
        if (!TextUtils.isEmpty(paramString4)) {
          paramString5.append("site=").append(com.mob.tools.b.b.c(paramString4, "utf-8")).append("&");
        }
        if (!TextUtils.isEmpty(paramString1))
        {
          if (paramString1.length() > 40)
          {
            ...
            paramString5.append("title=").append(com.mob.tools.b.b.c(paramString4, "utf-8")).append("&");
          }
        }
        else
        {
          if (!TextUtils.isEmpty(paramString3)) {
            paramString5.append("summary=").append(com.mob.tools.b.b.c(paramString3, "utf-8")).append("&");
          }
          if (!TextUtils.isEmpty(paramString2)) {
            paramString5.append("targeturl=").append(com.mob.tools.b.b.c(paramString2, "utf-8")).append("&");
          }
          if (!TextUtils.isEmpty(paramString6)) {
            paramString5.append("imageUrl=").append(com.mob.tools.b.b.c(paramString6, "utf-8")).append("&");
          }
  ...
  private void b(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, PlatformActionListener paramPlatformActionListener)
  {
    for (;;)
    {
      ...
      if (i != 0)
      {
        ...
        if (TextUtils.isEmpty(paramString4)) {
          paramString2 = com.mob.tools.b.a.a(this.a.getContext(), paramString5);
        }
        paramString2 = new com.mob.tools.a.i("pic", paramString2);
    ...
    if ((paramBoolean1) && (a()))
    {
      ...
      if (!TextUtils.isEmpty(paramString4))
      {
        ...
        if (localFile.exists())
        {
          ...
          {
            str = new File(com.mob.tools.b.g.e(this.a.getContext(), "images"), System.currentTimeMillis() + localFile.getName()).getAbsolutePath();
            if (!com.mob.tools.b.g.a(paramString4, str)) {
              break label267;
            }
          }
        }
  ...
  public HashMap<String, Object> e(String paramString)
  {
    ...
    paramString = new ArrayList();
    paramString.add(new com.mob.tools.a.i("access_token", this.g));
    paramString.add(new com.mob.tools.a.i("oauth_consumer_key", this.d));
    paramString.add(new com.mob.tools.a.i("openid", this.f));
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\cn\sharesdk\tencent\qq\e.class
