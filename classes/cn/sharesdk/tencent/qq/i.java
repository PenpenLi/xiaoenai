  ...
  extends a
{
  ...
  private void a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    ...
    try
    {
      ...
      a.registerExecutor(this.b, paramString3);
  ...
  private int[] a()
  {
    ...
    catch (Throwable localThrowable1)
    {
      try
      {
        ...
        {
          Object localObject;
          arrayOfInt[i] = g.d(localObject[i]);
          i += 1;
        }
  ...
  private String b(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    ...
    {
      paramString2 = paramString4 + "&req_type=" + Base64.encodeToString("5".getBytes(), 2);
      paramString1 = "10";
    }
    for (;;)
    {
      return paramString2 + "&cflag=" + Base64.encodeToString(paramString1.getBytes(), 2);
      if ((!TextUtils.isEmpty(paramString1)) && (!TextUtils.isEmpty(paramString3)) && (TextUtils.isEmpty(paramString2)))
      {
        paramString2 = paramString4 + "&req_type=" + Base64.encodeToString("6".getBytes(), 2);
        paramString1 = "00";
      }
      else if (!TextUtils.isEmpty(paramString6))
      {
        paramString1 = paramString4 + "&req_type=" + Base64.encodeToString("2".getBytes(), 2);
        paramString2 = paramString1 + "&audioUrl=" + Base64.encodeToString(paramString6.getBytes(), 2);
        paramString1 = "00";
      }
      else
      {
        paramString2 = paramString4 + "&req_type=" + Base64.encodeToString("1".getBytes(), 2);
        paramString1 = "00";
      }
    }
  }
  ...
  public void onCreate()
  {
    ...
    String str6 = c.a(this.activity).y();
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\cn\sharesdk\tencent\qq\i.class
