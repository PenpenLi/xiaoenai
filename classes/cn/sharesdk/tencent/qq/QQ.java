  ...
  extends Platform
{
  ...
  protected f.a filterShareContent(Platform.ShareParams paramShareParams, HashMap<String, Object> paramHashMap)
  {
    ...
    for (;;)
    {
      ...
      ((HashMap)localObject).put("appName", c.a(this.context).y());
    ...
    for (;;)
    {
      ...
      if (this.listener != null)
      {
        ...
        else if (((Integer)paramString.get("ret")).intValue() != 0)
        {
          if (this.listener != null)
          {
            paramString = new com.mob.tools.b.e().a(paramString);
...
/* Location:              E:\apk\xiaoenai2\classes-dex2jar.jar!\cn\sharesdk\tencent\qq\QQ.class
